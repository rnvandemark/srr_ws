\section{Prerequisite Knowledge}\label{traction_control:algorithms:prereqs}
\subsection{Ackermann Steering Model}\label{traction_control:algorithms:ackermann-steering-section}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.8\textwidth]{sections/algorithms/images/ackermann_steering.png}
...
\subsection{Rigid-Body Model Assumption}\label{traction_control:algorithms:rigid-body}
